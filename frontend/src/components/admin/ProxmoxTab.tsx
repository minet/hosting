...
function NodeCard({ node }: { node: ProxmoxNode }) {
  ...
  return (
    <div className="border border-neutral-200 rounded-lg p-4 bg-white shadow-sm overflow-hidden">
      <div className="flex items-center justify-between mb-4 min-w-0">
        <div className="flex items-center gap-2 min-w-0">
          <Server size={16} className="text-neutral-400 shrink-0" />
          <span className="font-semibold text-neutral-800 truncate">{node.node}</span>
        </div>
      ...
      <div className="flex flex-col gap-3">
        <div>
          <div className="flex items-center justify-between mb-1 min-w-0">
            ...
            <span className="text-xs font-mono text-neutral-500 truncate ml-2">
    ...
    <div className="flex flex-col gap-6 h-full overflow-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 shrink-0">
        <div className="border border-neutral-200 rounded-lg p-4 bg-white shadow-sm overflow-hidden">
          ...
          <div className="text-lg font-mono font-semibold text-neutral-800 mb-1 truncate">
            {totalCpu > 0 ? (usedCpu / totalCpu * 100).toFixed(1) : 0}%
          </div>
          <div className="text-xs text-neutral-400 truncate">{usedCpu.toFixed(1)} / {totalCpu} cores</div>
        ...
        <div className="border border-neutral-200 rounded-lg p-4 bg-white shadow-sm overflow-hidden">
          ...
          <div className="text-xs text-neutral-400 truncate">{formatBytes(usedMem)} / {formatBytes(totalMem)}</div>
        ...
        <div className="border border-neutral-200 rounded-lg p-4 bg-white shadow-sm overflow-hidden">
          ...
          <div className="text-xs text-neutral-400 truncate">{formatBytes(usedDisk)} / {formatBytes(totalDisk)}</div>
