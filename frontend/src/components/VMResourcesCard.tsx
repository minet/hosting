  ...
  return (
    <div className="border border-neutral-100 dark:border-neutral-800 shadow-md dark:shadow-none rounded-sm bg-white dark:bg-neutral-900 px-5 py-4 flex flex-col min-w-0 overflow-hidden">
      <div className="flex items-center justify-between mb-3 min-w-0 gap-2">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500 truncate">Ressources allouées</p>
      ...
      {vm ? (
        <div className="flex flex-col gap-2 min-w-0">
          <div className="flex items-center justify-between min-w-0 gap-2">
            ...
            <span className="text-sm font-bold text-neutral-800 dark:text-neutral-200 truncate">{vm.cpu_cores} <span className="text-xs font-normal text-neutral-400 dark:text-neutral-500">cœurs</span></span>
          </div>
          <div className="flex items-center justify-between min-w-0 gap-2">
            ...
            <span className="text-sm font-bold text-neutral-800 dark:text-neutral-200 truncate">{Math.round(vm.ram_mb / 1024)} <span className="text-xs font-normal text-neutral-400 dark:text-neutral-500">Go</span></span>
          </div>
          <div className="flex items-center justify-between min-w-0 gap-2">
            <span className="flex items-center gap-1.5 text-xs text-neutral-500 dark:text-neutral-400 shrink-0"><HardDrive size={13} className="text-emerald-500" />Disque</span>
            <span className="text-sm font-bold text-neutral-800 dark:text-neutral-200 truncate">{vm.disk_gb} <span className="text-xs font-normal text-neutral-400 dark:text-neutral-500">Go</span></span>
          </div>
        </div>
      ) : (
