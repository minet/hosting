...
class Settings(BaseSettings):
    ...
    admin_create_max_cpu_cores: int = Field(default=10, alias="ADMIN_CREATE_MAX_CPU_CORES")
    admin_create_max_ram_gb: int = Field(default=20, alias="ADMIN_CREATE_MAX_RAM_GB")
    admin_create_max_disk_gb: int = Field(default=100, alias="ADMIN_CREATE_MAX_DISK_GB")
